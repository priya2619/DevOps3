...
set CLASSPATH=%APP_HOME%\lib\MyProject.jar;%APP_HOME%\lib\slf4j-api-1.7.21.jar

@rem Execute MyProject
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MY_PROJECT_OPTS%  -classpath "%CLASSPATH%" com.capgemini.HelloWorld %CMD_LINE_ARGS%
